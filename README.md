...
* 「促／ん」
    ...
    * 例１） 以下のように設定したとき「mekki」と入力することで「めっき」と確定することができます。
        *  ローマ字:「me」、かな:「め」、促／ん: OFF
        *  ローマ字:「kk」、かな:「っ」、促／ん: ON
        *  ローマ字:「ki」、かな:「き」、促／ん: OFF
    * 例２） 以下のように設定したとき「kambann」と入力することで「かんばん」と確定することができます。
        *  ローマ字:「ka」、かな:「か」、促／ん: OFF
        *  ローマ字:「mb」、かな:「ん」、促／ん: ON
        *  ローマ字:「ba」、かな:「ば」、促／ん: OFF
        *  ローマ字:「nn」、かな:「ん」、促／ん: OFF
...
* 「待機」
    ...
    * 例１） カナキーロックした状態で「か」と濁点を入力することで「が」と入力することができます。濁点、半濁点のローマ字部分は、現状1文字のみ対応しています。
        * ローマ字:「ｶ」、かな:「か」、待機: ON　　　(JIS X 0201 仮名 → JIS X 0208 仮名)
        * ローマ字:「ﾞ」、かな:「゛」、待機: ON　　　(JIS X 0201 濁点 → JIS X 0208 濁点)
        * ローマ字:「か゛」、かな:「が」、待機: ON　　　(仮名と濁点の合成)
